...
public class NewTaskRequest extends AnalyserRequest {
    ...
    @Override
    public void dispatch(RuntimeHandler rh, Analyser analyser) throws AnalyserException {
        try {
            analyser.addTaskToGraph(task);
            rh.runTask(task);
