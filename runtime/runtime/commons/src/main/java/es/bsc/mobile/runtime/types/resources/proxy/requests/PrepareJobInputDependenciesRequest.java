...
public class PrepareJobInputDependenciesRequest implements ProxiedBackEndRequest, Externalizable {

    private String jobId;

    public PrepareJobInputDependenciesRequest() {
    }

    public PrepareJobInputDependenciesRequest(String jobId) {
