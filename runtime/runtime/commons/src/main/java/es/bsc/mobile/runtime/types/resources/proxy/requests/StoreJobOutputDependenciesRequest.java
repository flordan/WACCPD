...
public class StoreJobOutputDependenciesRequest implements ProxiedBackEndRequest, Externalizable {

    private String jobId;

    public StoreJobOutputDependenciesRequest() {
    }

    public StoreJobOutputDependenciesRequest(String jobId) {
    ...
    public void process(
        ...
        if (je != null) {
            je.storeJobOutputDataDependencies();
        } else {
