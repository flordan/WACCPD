...
public class DataCreationNotification extends Message<RuntimeNode> {
    ...
    public DataCreationNotification() {
    }

    public DataCreationNotification(String data, Node source) {
        super();
        this.data = data;
        this.source = source;
    }
    ...
    public void handleMessage(Connection source, RuntimeNode handler) {
        ...
        Log.i(LOGGER_TAG, "Received notification of data " + data + " creation in node " + this.source + ".");
        handler.handleDataCreation(this);
        handler.registerDataExistence(data);
    }

    @Override
    public String toString() {
        return "data " + data + " creation";
    }
