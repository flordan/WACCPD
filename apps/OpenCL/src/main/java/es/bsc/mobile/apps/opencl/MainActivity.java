...
public class MainActivity extends Activity {
    ...
    public void start(View aview) {
        ...
        EditText numElementsET = (EditText) findViewById(R.id.numelements_text);
        new Compute().execute(numElementsET.getText().toString());
    }
    ...
    private class Compute extends AsyncTask<String, Void, String> {
        ...
        protected String doInBackground(String... params) {
            ...
            int numElements = Integer.parseInt(params[0]);
            return Computation.start(numElements);
        }
